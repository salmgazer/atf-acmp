...
import { Home, Users, MessageSquare, User, Bell, Sun, Moon } from "lucide-react";
...
export function MentorLayout({ children, noPadding }: MentorLayoutProps) {
  ...
  const navItems = [
    { icon: Home, label: "Home", href: "/mentor/dashboard", badge: 0 },
    { icon: Users, label: "Teams", href: "/mentor/teams", badge: 0 },
    { icon: MessageSquare, label: "Chat", href: "/mentor/chat", badge: totalUnreadCount },
    { icon: User, label: "Profile", href: "/mentor/profile", badge: 0 },
  ];
